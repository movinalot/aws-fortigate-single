...
// byol, flex or payg
// byol - requires a file at deployment or after
// flex - requires an entitlement tokn at delpoyment or after
// payg - is billed by the Cloud provider
...
// Flex license token for the fgt
variable "license_token" {
  type    = string
  default = "C01BC4125ED95A3142B3"
}
  ...
  default = {
    us-east-1 = {
      arm = {
        ...
        flex = "ami-021b56da1d6c1aeec"
      },
      x86 = {
        payg = "ami-059d36a8887155edb"
        byol = "ami-0b8f59ecef2c7b3c7"
        flex = "ami-0b8f59ecef2c7b3c7"
      }
    },
    us-east-2 = {
      arm = {
...
variable "keyname" {
  default = "jmcdonough-fgt-ff-demo"
}
